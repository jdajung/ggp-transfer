...
public final class Experiment extends JPanel implements ActionListener
{
    static void createAndShowGUI(Experiment serverPanel, String title)
    {
    ...
    public static void main(String[] args)
    {
        ...
        final Experiment serverPanel = new Experiment();
