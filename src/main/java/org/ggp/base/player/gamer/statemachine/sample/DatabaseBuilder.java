...
public final class DatabaseBuilder extends JPanel implements ActionListener
{
    static void createAndShowGUI(DatabaseBuilder serverPanel, String title)
    {
    ...
    public static void main(String[] args)
    {
        ...
        final DatabaseBuilder serverPanel = new DatabaseBuilder();
      ...
      //*************** Do Stuff Here ******************
        GameRepository repo = serverPanel.getGameSelector().getSelectedGameRepository();
